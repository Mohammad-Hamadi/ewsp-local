...
try {
    ...
    Assert-Contains $composeConfiguration 'EWSP_MOBILE_LATEST_VERSION: ${EWSP_MOBILE_LATEST_VERSION:-1.0.2}' 'Compose backend receives the current mobile version with a development-safe default'
    Assert-Contains $composeConfiguration 'EWSP_MOBILE_LATEST_VERSION_CODE: ${EWSP_MOBILE_LATEST_VERSION_CODE:-3}' 'Compose backend receives mobile version code 3'
    Assert-Contains $composeConfiguration 'EWSP_MOBILE_UPDATE_URL: ${EWSP_MOBILE_UPDATE_URL:-https://github.com/Mohammad-Hamadi/ewsp-mobile/releases/download/v1.0.2/ewsp-1.0.2.apk}' 'Compose backend receives the exact HTTPS mobile update URL'
    ...
    $exactMobileUrl = 'https://github.com/Mohammad-Hamadi/ewsp-mobile/releases/download/v1.0.2/ewsp-1.0.2.apk'
    Assert-Contains $backendConfigText 'EWSP_MOBILE_LATEST_VERSION: 1.0.2' 'backend ConfigMap contains exact mobile version 1.0.2'
    Assert-Contains $backendConfigText 'EWSP_MOBILE_LATEST_VERSION_CODE: "3"' 'backend ConfigMap contains exact mobile version code 3'
    ...
    Assert-Contains $envExampleText 'EWSP_MOBILE_LATEST_VERSION=1.0.2' 'local environment example documents mobile version 1.0.2'
    Assert-Contains $envExampleText 'EWSP_MOBILE_LATEST_VERSION_CODE=3' 'local environment example documents mobile version code 3'
    ...
    Set-Content -LiteralPath $fingerprintFixture -Value ($backendConfigText.Replace('EWSP_MOBILE_LATEST_VERSION_CODE: "3"','EWSP_MOBILE_LATEST_VERSION_CODE: "4"')) -NoNewline
